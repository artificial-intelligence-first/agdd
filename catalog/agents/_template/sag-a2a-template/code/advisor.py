...
def run(payload: Dict[str, Any], *, skills: Any = None, obs: Any = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if call_depth > 10:
            if obs:
                obs.log("a2a_deep_call_chain_warning", {
                    "call_depth": call_depth,
                    "correlation_id": correlation_id,
                })
