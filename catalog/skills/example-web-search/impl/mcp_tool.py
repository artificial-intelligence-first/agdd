...
INPUT_CONTRACT = ROOT / "catalog" / "skills" / "example-web-search" / "contracts" / "input.schema.json"
OUTPUT_CONTRACT = ROOT / "catalog" / "skills" / "example-web-search" / "contracts" / "output.schema.json"
