...
class TestRegistry:
    ...
    def test_resolve_entrypoint(self):
    ...
    def test_resolve_entrypoint_invalid_format(self):
    ...
    def test_resolve_entrypoint_file_not_found(self):
