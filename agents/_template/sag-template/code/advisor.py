...
TODO: Customize this template for your specific domain logic.
"""
...
def run(payload: Dict[str, Any], *, skills=None, obs=None) -> Dict[str, Any]:
    ...
    try:
        # ===== Input Extraction =====
        # TODO: Extract fields from payload according to input schema
        ...
        # ===== Domain Logic =====
        # TODO: Implement your specialized processing logic
        ...
        # ===== Output Construction =====
        # TODO: Build output according to your_advisor_output schema
        output = {
            "result": {
