...
The AGDD storage layer provides a pluggable, scalable data management system for agent execution logs, metrics, and artifacts.

## Overview

The storage layer replaces the legacy file-based observability system (`.runs/agents/`) with a more sophisticated approach that supports:
