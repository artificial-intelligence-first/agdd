...
from agdd.observability.tracing import get_meter, trace_span
...
def force_removal_allowed() -> bool:
    ...
    flag = os.environ.get("AGDD_WT_ALLOW_FORCE", "")
    return flag.lower() in {"1", "true", "yes"}


@dataclass(slots=True)
class WorktreeRecord:
    """Aggregate of Git state and AGDD metadata for a worktree."""
...
class WorktreeManager:
    ...
    def create(
        ...
        *,
        ...
        """Create a new worktree following AGDD naming conventions."""
    ...
    def remove(self, run_id: str, *, force: bool = False) -> None:
        ...
        if force and not force_removal_allowed():
            raise WorktreeForbiddenError(
                ...
                "Set AGDD_WT_ALLOW_FORCE=1 in trusted contexts."
            )
