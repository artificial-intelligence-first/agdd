"""Semantic cache with vector search support for MAGSAG framework.
...
class CacheConfig(BaseSettings):
    ...
    Attributes:
        ...
        redis_index_name: Redis index name (default: "magsag_cache")
    ...
    def __init__(self, config: CacheConfig) -> None:
        ...
        try:
            ...
            msg = (
                ...
                "Install with: pip install 'magsag[faiss]'"
            )
    ...
    def __init__(self, config: CacheConfig) -> None:
        ...
        try:
            ...
            msg = (
                ...
                "Install with: pip install 'magsag[redis]'"
            )
            raise ImportError(msg) from e
