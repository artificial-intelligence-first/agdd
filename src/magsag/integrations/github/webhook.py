"""GitHub webhook handlers for MAGSAG integration.
...
from magsag.api.run_tracker import find_new_run_id, snapshot_runs
...
def format_success_comment(
    ...
    comment = f"✅ **MAGSAG Agent `{slug}` execution completed**\n\n"
...
def format_error_comment(slug: str, error: Exception) -> str:
    ...
    comment = f"❌ **MAGSAG Agent `{slug}` execution failed**\n\n"
