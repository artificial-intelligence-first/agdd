...
cat > ops/scripts/flowrunner-env.sh <<EOF
#!/bin/bash
# Flow Runner environment variables
# Generated by ops/scripts/setup-flowrunner.sh
# Usage: source ops/scripts/flowrunner-env.sh
...
chmod +x ops/scripts/flowrunner-env.sh
